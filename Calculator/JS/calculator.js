...
//this modifies values eachtime a button is clicked
function Input_Digit(digit) {
    const { Display_Value, Wait_Second_Operand } = Calculator;
    //we are checking to see if wait_second-op is ture and set
// Display_value to the key if cicked
...
function Handle_Operator(Next_Operator)  {
    ...
    //when an operand key is pressed, we converst the current number
// displayed on the screen to a number and then stor the result in
